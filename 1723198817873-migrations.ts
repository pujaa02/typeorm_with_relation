...
export class Migrations1723198817873 implements MigrationInterface {
  name = 'Migrations1723198817873';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "rating" DROP CONSTRAINT "FK_112330235392f7da7983545be71"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order_product" DROP CONSTRAINT "FK_b35b68038508d47ddbd5fc8ce9d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_product" DROP CONSTRAINT "FK_9a427590b6f2dafbcbf37172b98"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notification" DROP CONSTRAINT "FK_1566e360a324bc11a06eb3750af"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" DROP CONSTRAINT "FK_158290aea1aeac94f43ff5ac34b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "menu" DROP CONSTRAINT "FK_085156de3c3a44eba017a6a0846"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cart" DROP CONSTRAINT "FK_b9ef443130e13608fa7ee11fa88"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cart" DROP CONSTRAINT "FK_756f53ab9466eb52a52619ee019"`,
    );
    await queryRunner.query(
      `ALTER TABLE "restaurant" DROP CONSTRAINT "FK_43ebcd49fca84c2fda8c077ac68"`,
    );
